...
### External online demos
Online demos are maintained externally and are not part of this CLI repository.
...
`mineru` currently supports local `PDF`, image, `DOCX`, `PPTX`, and `XLSX` file or directory inputs through the command line. For detailed instructions, please refer to the [Usage Guide](https://opendatalab.github.io/MinerU/usage/).
